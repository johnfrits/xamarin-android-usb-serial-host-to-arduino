...
namespace android_usb_host_arduino
{
    ...
    //                {
    //                    if (usbif.GetEndpoint(j).GetType().Equals(UsbSupport.UsbEndpointXferBulk))
    //                    {
    //                        if (usbif.GetEndpoint(j).Direction.Equals(UsbSupport.UsbDirOut))
    //                        {
    //                            tOut = usbif.GetEndpoint(j);
    //                        }
    //                        else if (usbif.GetEndpoint(j).Direction.Equals(UsbSupport.UsbDirIn))
    //                        {
    ...
    //            {
    //                byte rxCmd = Convert.ToByte(buffer.Get(0));
    //                if (rxCmd != 0)
    //                {
    //                    bar.Progress = ((int)rxCmd);
    //                }
